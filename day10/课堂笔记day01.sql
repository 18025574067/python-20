...
+--------+-------------------------+------+-----+---------+----------------+
        ...
        --多行插入
        insert into students values(null, "欧阳铁娃", 18, 1.78, "妖", 1), (null, "诸葛铁柱", 18, 1.78, "妖", 1);
    ...
    --update 表名 set 列1=值1, 列2=值2... where 条件；
        ...
        --按条件修改
        update students set age=18 where name="司马狗剩";
        update students set high=1.65, gender="男", cls_id=2 where name="司马狗剩
";
    ...
    --数据库备份与恢复（了解）
        ...
        mysqldump -uroot -p python_db1 > python_db1.sql
